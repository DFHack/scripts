...
materials['leatherworker'] = {'CREATURE_MAT:RUTHERER:LEATHER','CREATURE_MAT:ELK_BIRD:LEATHER','CREATURE_MAT:BIRD_TURKEY:LEATHER','CREATURE_MAT:DRALTHA:LEATHER','CREATURE_MAT:JABBERER:LEATHER','CREATURE_MAT:VORACIOUS_CAVE_CRAWLER:LEATHER','CREATURE_MAT:BAT_GIANT:LEATHER'}
